...
and Offer.specialization_id = Offer_Language.specialization_id and User.id = Offer.user_id";
  ...
  public static function getOffersByLang($lang) {
    $sql = "select CONCAT(User.initials,User.tag)As tag_user ,User.tag,User.initials,Offer.user_id,Offer_Language.language_id,User.name,Offer_Language.title,Offer_Language.description,Offer.personal_valoration,Offer.valoration_avg,Offer.coin_price
from Offer,Offer_Language,User where Offer.user_id = Offer_Language.user_id
and Offer.specialization_id = Offer_Language.specialization_id and User.id = Offer.user_id
...
and Offer_Language.language_id='$lang' and User.id = '$id'";
    ...
    $sql = "select User.tag,User.initials,Offer.user_id,Offer_Language.language_id,User.name,Offer_Language.title,Offer_Language.description,Offer.personal_valoration,Offer.valoration_avg,Offer.coin_price
  from Offer,Offer_Language,User where Offer.user_id = Offer_Language.user_id
  and Offer.specialization_id = Offer_Language.specialization_id and User.id = Offer.user_id
  and Offer_Language.title = '$offerTitle'
