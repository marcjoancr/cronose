      ...
      <div class="collapse navbar-collapse" id="language">
        ...
        <ul class="navbar-nav mr-auto" id="language_selector" name="lang" target="_self">
          ...
          <?php if(!isset($_SESSION['user'])) {
            echo '<button type="button" class="btn btn-dark btn-lg login">LOG IN</button>';
            echo '<button type="button" class="btn btn-secondary btn-lg register">REGISTER</button>';
          } else {
              echo '<button type="button" class="btn btn-secondary btn-lg">LOG OUT</button>';
          }?>
